...
public class IrcModule extends Thread implements Serializable {
	...
	public boolean				status				= true;		// initial state is on
	public boolean				verbose				= true;		// debug
	
	public int					botIndex			= -1;		// index in the bot, where the mod is loaded
	...
	// initializer
	// child modules should call this method
	...
	protected void dispose()
	{
		...
		// interrupt this thread (ie: stop it)
		interrupt();
	}
    ...
    public final void log( String line )
    {
    	...
    	if(verbose)
    		parent.log("[" + getName() + "] " +  line);
    	
    }
    public boolean isModLoaded() {					// requires that bot is connected, and bot index is set
