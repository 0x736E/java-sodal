...
public abstract class PircBot implements ReplyConstants {
    ...
    public String _name = "PircBot";
    private String _nick = _name;
    public String _login = "PircBot";
    public String _version = "PircBot " + VERSION + " Java IRC Bot - www.jibble.org";
    public String _finger = "You ought to be arrested for fingering a bot!";
